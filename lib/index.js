...
export function apply(ctx) {
  ...
  const hooks = createHooks({
    ...
    scanToolParams,
    scanToolResult,
    createGuardMessage: (text) => createUserMessage({ content: [{ type: "text", text }] }),
  });
          ...
          tools.register(
            defineTool({
              ...
              parameters: {
                ...
                category: { type: "string", required: false, description: "Optional category hint (instruction_override / role_impersonation / ...)." },
              },
